          ...
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4">
            <div className="bg-gradient-to-b from-[#121C48] to-[#0A0F24] text-white p-6 rounded-2xl shadow-xl w-[360px]">
              ...
              <div className="flex gap-2 mb-4">
                <button className="px-3 py-1 bg-teal-500 rounded-lg text-black text-sm font-semibold" onClick={applyToday}>Today</button>
                <button className="px-3 py-1 bg-gray-300 rounded-lg text-black text-sm font-semibold" onClick={applyLast7Days}>Last 7 Days</button>
                <button className="px-3 py-1 bg-gray-300 rounded-lg text-black text-sm font-semibold" onClick={applyThisMonth}>This Month</button>
              </div>
              ...
              {calendar.map((row, rowIndex) => (
                <div key={rowIndex} className="grid grid-cols-7 text-center my-1">
